								...
								<div class="themesflat-container">
									<div class="row">
										<div class="col-12">
											...
											<p>Craving some delicious Paris food? Maybe you’re in the mood for a juicy steak? No matter what kind of meal you have in <br> mind, The Brochette Restaurant is ready to prepare it for you.</p>
											<a class="button-two-line" href="menu-1.html">DISCOVERY MENU</a>
										</div>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="content">
								...
								<a class="button-two-line wow fadeInUp" href="about.html">LEBIH LANJUT</a>
							</div>
						</div>
						<div class="col-lg-5">
					...
					<div class="row">
						<div class="col-lg-7">
							<div class="image wow fadeInLeft">
								<img src="<?= base_url() ?>assets/front/images/logo/logo-bg-gelap.png" alt="">
							</div>
						</div>
						<div class="col-lg-5">
							<div class="content">
			...
			<div class="event-grid">
				<div class="box-event">
					<img src="<?= base_url() ?>assets/front/images/item-background/business-meeting.jpg" alt="">
					<div class="content">
				...
				<div class="box-event">
					<img src="<?= base_url() ?>assets/front/images/item-background/training-workshop.jpg" alt="">
					<div class="content">
				...
				<div class="box-event">
					<img src="<?= base_url() ?>assets/front/images/item-background/gathering-community.jpg" alt="">
					<div class="content">
